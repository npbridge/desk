<template>
  <div>
    <div v-if="ticket" class="flex flex-col h-screen grow-0">
      ...
      <div
        v-if="ticket"
        class="flex border-t w-full flex-col md:flex-row"
        :style="{ height: viewportWidth > 768 ? 'calc(100vh - 72px)' : null }"
      >
        <div class="border-r md:w-[252px] shrink-0">
          <ActionPanel :ticketId="ticket.name" />
        </div>
        <div
          class="grow flex flex-col h-full md:overflow-x-scroll conversation"
        >
              ...
              <div class="grow">
                <div class="grow flex flex-row items-center space-x-[13.5px]">
                  ...
                  <a
                    ...
                    class="max-w-[200px] md:max-w-[550px] cursor-pointer font-semibold"
                  >
                    {{ ticket.subject }}
                  </a>
                  <Button
                    :appearance="isFollowed ? 'secondary' : 'primary'"
                    @click="toggleFollow"
                  >
          ...
          <div class="grow overflow-scroll px-[18px]">
            ...
            <Conversations
              ...
              :autoScroll="['Open', 'Replied'].includes(ticket.status)"
            />
          </div>
          <div
          ...
          >
            <CustomTextEditor
              ...
              "
              editorClasses="w-full min-h-[180px] max-h-[300px] "
                ...
                <div>
                  ...
                  >
                    ...
                    <div class="flex flex-row items-center space-x-2">
                      ...
                      <CustomIcons
                        :class="editor.isActive('link') ? 'bg-gray-100' : ''"
                        name="link-url"
                        class="h-7 w-7 rounded p-1"
                        role="button"
                        @click="$refs.replyEditor.insertLink"
                      />
                    </div>
                    <div class="grow flex flex-row-reverse">
                      <FeatherIcon
            ...
            <div>
              <div
                v-if="!editing"
                class="flex flex-row space-x-[14px] justify-end md:justify-start"
              >
        ...
        <div class="border-l bg-gray-50 md:w-[252px] shrink-0">
...
@media screen and (min-width: 768px) {
  .conversation {
    width: calc(((100vh - 252px) - 240px) - 252px);
  }
}
</style>
<script>
