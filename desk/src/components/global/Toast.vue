    ...
    <transition :name="position.includes('top') ? 'toast-top' : 'toast-bottom'">
      <div
        ...
        :class="[
          ...
          position.includes('top') ? 'my-[40px] md:my-[80px]' : 'my-[10px]',
        ]"
      >
        <div
          class="px-5 pt-[14px] pb-[12px] rounded-lg shadow-md min-w-[15rem] md:min-w-[25rem] max-w-[40rem] flex flex-col space-y-5"
          :class="bodyClasses"
        >
                ...
                >
                  ...
                  >
                    <Input
                      ...
                      @input="
                        (val) => {
                          formInputs[input.fieldname] = val
                        }
                      "
                    />
                  </div>
