          ...
          <div class="pl-[8px] py-[5.5px] flex items-center">
            <div class="w-[14px]">
              <FeatherIcon
                ...
                :name="option.expanded ? 'chevron-up' : 'chevron-down'"
              />
            </div>
            <div class="w-[24px]">
              <CustomIcons
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div class="text-[11px] font-normal mr-[10px] text-gray-500">
                    {{ childOption.extra }}
                  </div>
                </div>
              </router-link>
      ...
      <div class="mx-[8px] pb-[17px] flex flex-col">
        ...
        >
          ...
          <div class="flex flex-col text-gray-700">
            ...
            <span class="truncate text-[11px] font-normal">{{
              user.user
            }}</span>
          </div>
        </div>
  ...
  methods: {
    ...
    syncSideBarTicketFilter() {
      ...
      this.ticketSideBarFilter =
        this.$route.name === 'DeskTickets' && this.$route.query.menu_filter
          ? this.$route.query.menu_filter
          : this.ticketSideBarFilter
    },
