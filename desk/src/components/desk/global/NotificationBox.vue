  ...
  <div class="dropdown-menu notifications-list" role="menu">
    <div class="notification-list-header">
      <div class="header-items">
        <ul class="notification-item-tabs nav nav-tabs" role="tablist">
          <li
            class="notifications-category active"
            id="notifications"
    ...
    <div class="notification-list-body" v-for="notification in notifications">
      <div class="panel-notifications">
        <a
          class="recent-item notification-item"
          :href="`/frappedesk/tickets/${
            notification.document_name && notification.document_name
          }`"
        >
          <div class="notification-body">
            ...
            >
              <div
                ...
                style="background-color: #eaf5ee; color: #2f9d58"
              >
            ...
            <div class="message">
              ...
              <div class="notification-timestamp text-muted">
                ...
                >
                  {{ notification.diffDays }} days ago</span
                >
              </div>
            </div>
          </div>
