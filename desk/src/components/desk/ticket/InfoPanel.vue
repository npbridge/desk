<template>
  <div class="pt-[20px] h-full flex flex-col" v-if="ticket">
    ...
    >
      <div class="md:hidden text-[16px] font-normal text-gray-500 pb-5">
        Contact Info
      </div>
        ...
        <div v-if="!editingContact">
          <div v-if="ticket.contact" class="space-y-[12px]">
            ...
            <div class="flex flex-col space-y-[8px]">
              ...
              <div
                v-if="ticket.contact.course.length > 0"
...
export default {
  ...
  methods: {
    createAndAssignContactCourseFromDialog() {
      if (this.newCourse) {
        this.ticketController
          .set(this.ticket.contact.name, 'course', this.newCourse)
          .then(() => {
    ...
    removeCourse(course) {
      this.ticketController
        .delete(this.ticket.contact.name, 'course', course)
        .then(() => {
          this.$resources.ticket.fetch()
