<template>
  ...
  >
    <div v-if="agent" role="button" class="flex items-center text-base">
      ...
      >
        <div class="md:w-4/12 truncate pr-10">
          {{ agent.full_name }}
        </div>
        <div class="md:w-5/12 truncate pr-10 hidden md:block">
          {{ agent.email }}
        </div>
        <div class="md:w-3/12 truncate pr-10 hidden md:block">
          {{ agent.group }}
        </div>
        <div class="md:w-2/12 truncate">
