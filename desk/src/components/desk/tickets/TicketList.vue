<template>
  <div>
    ...
    >
      ...
      <div
        class="md:w-1/12 flex flex-row items-center space-x-[7px] cursor-pointer hidden md:block"
      ...
      <div
        class="w-9/12 md:w-7/12 flex flex-row items-center space-x-[6px] cursor-pointer"
      ...
      <div
        class="w-3/12 flex flex-row items-center space-x-[6px] cursor-pointer"
      ...
      <div
        class="md:w-3/12 flex flex-row items-center space-x-[6px] cursor-pointer hidden md:block"
      ...
      <div
        class="md:w-2/12 flex flex-row items-center space-x-[6px] cursor-pointer hidden md:block"
      ...
      <div
        class="md:w-1/12 flex flex-row items-center space-x-[6px] cursor-pointer hidden md:block"
      ...
      <div
        class="md:w-1/12 text-[11px] flex flex-row-reverse text-gray-500 hidden md:flex"
      >
